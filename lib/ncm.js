...
// This adapter does not enable general unblock/degray behaviour. It only asks
// upstream APIs for URLs available to the configured account/session.
...
async function callByHttp(route, params) {
  ...
  const response = await fetch(url, {
    method: 'GET',
    headers: {
      'User-Agent': 'meting-enhanced-vercel/0.5',
