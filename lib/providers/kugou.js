...
async function qrLoginStart() {
  try {
    ...
    // APP 扫码需要完整 H5 链接 (解码服务端二维码图片确认)
    // 内容: https://h5.kugou.com/apps/loginQRCode/html/index.html?appid=1005&qrcode=xxx
    const qrContent = `${KG_QRCODE_H5}?appid=${KG_APPID}&qrcode=${qrcode}`;
